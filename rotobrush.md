...
where $$p_c$$    \( p_c(x\mathcal{F}) \) and \(p_c(x \vert \mathcal{B})\) are the corresponding probabilities computed from the two GMMs. <i>Refer to section 2.1 for more details.</i>
