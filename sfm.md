...
$$\underset{x}{\operatorname{min}}\sum_{j=1,2}\left(u^j - \cfrac{P_1^{jT}\widetilde{\phi}{P_3^{jT}\widetilde{X}}\right)^2 + \left(v^j - \cfrac{P_2^{jT}\widetilde{\phi}{P_3^{jT}\widetilde{X}}\right)^2$$
